...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}backend/auth/css/styles.css">
    <title>SignUp</title>
    <style>
        .Section{
            background-image: url("{{asset('/')}}backend/auth/img/3.jpg");
        ...
        <div class="wrapper">
            ...
            <form class="form pt" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="input_field">
                  ...
                  <div class="input_field">
                    <input type="text" placeholder=" Enter Your Phone" name="phone" value="{{old('phone')}}"  class="input" id="" onkeyup="validateEmail()">
                    @error('phone')
                        <span style="color: red">{{$message}}</span>
                    @enderror
...
<script src="{{asset('/')}}backend/auth/js/scripts.js"></script>
</body>
